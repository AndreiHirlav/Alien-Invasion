...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.ship = Ship(self)
        self.bullets = pygame.sprite.Group() #behaves like a list with some extra functionalities
    ...
    def _check_play_button(self, mouse_pos):
        #Start the game when the players clicks Play
    ...
    def _update_bullets(self):
        ...
        #We cant modify a list within a for loop, so we loop a copy of the group
    ...
    def _check_bullet_alien_collisions(self):
        #Check for bullets that have hit alients and get rid of them
    ...
    def _check_fleet_edges(self):
        #Change the direction if any aliens have reached an edge
    ...
    def _update_screen(self):
        ...
        self.aliens.draw(self.screen) #Draws each element of the group
        ...
        pygame.display.flip() #makes the most recent drawn screen visible
